...
export type ChangePixelColorMutation = { __typename?: 'mutation_root', change_pixel_color?: { __typename?: 'PixelResponseResultResponse', result: boolean, value: { __typename?: 'PixelResponse', author_id: number, color: string, creation_time: string, id: number, x: number, y: number } } | null };
...
export type CreatePixelMutation = { __typename?: 'mutation_root', create_pixel?: { __typename?: 'PixelResponseResultResponse', result: boolean, value: { __typename?: 'PixelResponse', author_id: number, color: string, creation_time: string, id: number, x: number, y: number } } | null };
